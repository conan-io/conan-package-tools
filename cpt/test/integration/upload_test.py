...
"""
    ...
    def test_no_credentials(self):
        ...
        mp = ConanMultiPackager(username="lasote", out=self.output.write,
                                ...
                                upload=("https://bincrafters.jfrog.io/artifactory/api/conan/public-conan",
    ...
    def test_existing_upload_repo(self):
        self.api.remote_add("my_upload_repo", "https://bincrafters.jfrog.io/artifactory/api/conan/public-conan")
        self.save_conanfile(self.conanfile)
        with tools.environment_append({"CONAN_PASSWORD": "mypass"}):
            mp = ConanMultiPackager(username="lasote", out=self.output.write,
                                    ci_manager=self.ci_manager,
            ...
            self.assertIn("Remote for URL 'https://bincrafters.jfrog.io/artifactory/api/conan/public-conan' "
    ...
    def test_existing_upload_repo_by_name(self):
        ...
        with tools.environment_append({"CONAN_PASSWORD": "mypass",
            ...
            self.assertEquals(repo.url, "https://bincrafters.jfrog.io/artifactory/api/conan/public-conan")
