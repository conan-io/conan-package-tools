...
- **docker_selinux**: Running SELinux which means Docker volume requires :z suffix. Default [False]
...
- **CONAN_DOCKER_SELINUX**: Running SELinux which means Docker volume requires :z suffix.
